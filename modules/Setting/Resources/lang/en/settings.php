...
return [
    ...
    'tabs' => [
        ...
        'enable_paytr_installment' => 'Enable Installments',
        'paytr_commission_to_customer' => 'Pass commission to customer',
        'paytr_mode_iframe'    => 'iFrame (Hosted Form)',
        'paytr_mode_direct'    => 'Direct API (Own Form)',
    ],
    'form' => [
        'logo' => 'Logo',
