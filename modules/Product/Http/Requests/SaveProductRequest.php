...
class SaveProductRequest extends Request
{
    ...
    public function getProductRules(): array
    {
        return array_merge(
            [
                ...
                'fixed_prices' => 'nullable|array',
                'fixed_prices.*' => 'nullable|numeric|min:0|max:99999999999999',
    ...
    public function getProductVariantsRules(): array
    {
        return [
            ...
            'variants.*.fixed_prices' => 'nullable|array',
            'variants.*.fixed_prices.*' => 'nullable|numeric|min:0|max:99999999999999',
