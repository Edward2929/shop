...
class OrderService
{
    ...
    private function store($request)
    {
        return Order::create([
            ...
            'sub_total' => Cart::subTotal()->defaultCurrencyAmountForOrder(),
            'shipping_method' => Cart::shippingMethod()->name(),
            'shipping_cost' => Cart::shippingCost()->defaultCurrencyAmountForOrder(),
            'coupon_id' => Cart::coupon()->id(),
            'discount' => Cart::discount()->defaultCurrencyAmountForOrder(),
            'total' => Cart::total()->defaultCurrencyAmountForOrder(),
